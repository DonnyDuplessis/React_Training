...
};
{
    ...
    //
    var exampleArray = ['sfa', 'fafa', 'atea'];
    exampleArray.push('aa');
    var name1 = exampleArray[0], name2 = exampleArray[1];
    var exampleArrayCopy = __spreadArray(__spreadArray([], exampleArray, true), ['test', 'hi'], false);
    //
    // myinput: HTMLInputElement = document.getElementById("transactions") as HTMLInputElement
    var transactionArray_1 = [123, 567];
    var newTransaction = function (input) {
        var myinput = document.getElementById("transactions");
        transactionArray_1.push(Number(myinput.value));
